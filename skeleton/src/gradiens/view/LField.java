...
public class LField extends JLabel {
    ...
    private static ImageIcon negy = new ImageIcon("pics/4.png");
    private static ImageIcon nyolc = new ImageIcon("pics/8.png");
    private static ImageIcon negyF = new ImageIcon("pics/4f.png");
    private static ImageIcon nyolcF = new ImageIcon("pics/8f.png");
    ...
    public LField(Field a, int w, int h) {
        ...
        if (lathato) {
            ...
            // Lathato, nem sima mezo
                ...
                ImageIcon temp = new ImageIcon("pics/" + path);
